...
static char *font = "CaskaydiaCove Nerd Font,CaskaydiaCove:pixelsize=15:antialias=true:autohint=true";
...
unsigned int const highlightBg = 10, highlightFg = 1;
...
#define MODSHIFT (Mod4Mask|ShiftMask)
...
static Shortcut shortcuts[] = {
	...
	{ MODSHIFT|ControlMask, XK_J,           zoom,           {.f = +1} },
	{ MODSHIFT|ControlMask, XK_K,           zoom,           {.f = -1} },
	{ MODKEY,               XK_Home,        zoomreset,      {.f =  0} },
	{ TERMMOD,              XK_C,           clipcopy,       {.i =  0} },
	{ TERMMOD,              XK_V,           clippaste,      {.i =  0} },
	{ TERMMOD,              XK_Y,           selpaste,       {.i =  0} },
	{ TERMMOD,              XK_Num_Lock,    numlock,        {.i =  0} },
	{ TERMMOD,              XK_O,           normalMode,     {.i =  0} },
};
